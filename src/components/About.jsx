    ...
    <Tilt className="xs:w-[250px] w-full">
      ...
      >
        <div
          ...
          className="bg-tertiary rounded-[20px] py-5 px-12 min-h-[280px] flex jutify-evenly items-center flex-col"
        >
...
const About = () => {
  return (
    <>
      ...
      >
        I'm a skilled software develper with experience in TypeScript and JavaScript, 
